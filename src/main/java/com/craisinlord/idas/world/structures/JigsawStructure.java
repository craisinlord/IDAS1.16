...
public class JigsawStructure extends AbstractBaseStructure<NoFeatureConfig> {
    ...
    protected final Set<IDASStructureTagMap.STRUCTURE_TAGS> avoidStructuresSet;
    ...
    public JigsawStructure(ResourceLocation poolID, Lazy<Integer> structureSize, int centerOffset, int biomeRange,
                           int structureBlacklistRange, Set<IDASStructureTagMap.STRUCTURE_TAGS> avoidStructuresSet,
                           ...
                           int fixedYSpawn, boolean useHeightmap, boolean cannotSpawnInWater)
    {
        ...
        IDASStructures.IDAS_STRUCTURE_START_PIECES.add(startPool);
    }
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource, long seed, SharedSeedRandom chunkRandom, int chunkX, int chunkZ, Biome biome, ChunkPos chunkPos, NoFeatureConfig defaultFeatureConfig) {
        ...
        for (int curChunkX = chunkX - structureBlacklistRange; curChunkX <= chunkX + structureBlacklistRange; curChunkX++) {
            for (int curChunkZ = chunkZ - structureBlacklistRange; curChunkZ <= chunkZ + structureBlacklistRange; curChunkZ++) {
                for(IDASStructureTagMap.STRUCTURE_TAGS tag : avoidStructuresSet){
                    for(Structure<?> structureFeature : IDASStructureTagMap.REVERSED_TAGGED_STRUCTURES.get(tag)){
    ...
    public static class Builder<T extends Builder<T>> {
        ...
        protected Set<IDASStructureTagMap.STRUCTURE_TAGS> avoidStructuresSet = new HashSet<>();
        ...
        public T setAvoidStructuresSet(Set<IDASStructureTagMap.STRUCTURE_TAGS> avoidStructuresSet){
            this.avoidStructuresSet = avoidStructuresSet;
            return getThis();
        }
