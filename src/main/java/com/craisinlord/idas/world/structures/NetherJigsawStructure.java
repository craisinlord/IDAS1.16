...
public class NetherJigsawStructure extends JigsawStructure {
    ...
    public NetherJigsawStructure(ResourceLocation poolID, Lazy<Integer> structureSize, int centerOffset, int biomeRange,
    ...
    public static class Builder<T extends Builder<T>> extends JigsawStructure.Builder<T> {
        ...
        public NetherJigsawStructure build() {
            return new NetherJigsawStructure(
                    startPool,
                    structureSize,
                    centerOffset,
                    biomeRange,
