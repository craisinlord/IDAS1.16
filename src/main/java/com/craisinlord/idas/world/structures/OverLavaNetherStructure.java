...
public class OverLavaNetherStructure extends JigsawStructure {
    ...
    public OverLavaNetherStructure(ResourceLocation poolID, Lazy<Integer> structureSize, int centerOffset, int biomeRange,
    ...
    public static class Builder<T extends JigsawStructure.Builder<T>> extends JigsawStructure.Builder<T> {

        public Builder(ResourceLocation startPool) {
            super(startPool);
        }

        public OverLavaNetherStructure build() {
            return new OverLavaNetherStructure(
                    startPool,
                    structureSize,
                    centerOffset,
                    biomeRange,
