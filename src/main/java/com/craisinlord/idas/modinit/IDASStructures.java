...
public final class IDASStructures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> FARMHOUSE = addToStructureMaps("farmhouse", () -> (new JigsawStructure.Builder<>(new ResourceLocation(IDAS.MODID, "farmhouse/farmhouse")).setStructureSize(1).setTerrainHeightRadius(2).setAllowTerrainHeightRange(15).setStructureBlacklistRange(1).setAvoidStructuresSet(Stream.of(IDASStructureTagMap.STRUCTURE_TAGS.GENERIC_AVOID_STRUCTURE).collect(Collectors.toSet())).build()));
    ...
    public static void setupStructures() {
        ...
        //addToTerraformingAndStructureMaps(new ResourceLocation(IDAS.MODID, "underground_camp"), UNDERGROUND_CAMP.get(), GenerationStage.Decoration.UNDERGROUND_STRUCTURES, createSpacingAndSalt(IDASConfig.undergroundcampAverageChunkDistance.get(), 0.5f, 65471968));
        //addToTerraformingAndStructureMaps(new ResourceLocation(IDAS.MODID, "underground_camp_deep"), UNDERGROUND_CAMP_DEEP.get(), GenerationStage.Decoration.UNDERGROUND_STRUCTURES, createSpacingAndSalt(IDASConfig.undergroundcampdeepAverageChunkDistance.get(), 0.5f, 65471969));
        ...
        // underground camps used 2, use 70
